...
class _LandingScreenState extends State<LandingScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    // removes all key-value pairs inside this box
  ...
  Future<void> debugPrintAllPreferences() async {
    ...
    print("========== USER DIET PREF CHECK ==========");

    // Religion
    final religion = box.get("religion_pref");
    print("Religion Pref:");
    print(religion ?? "❌ No religion preference saved");

    print("------------------------------------------");

    // Ethical
    final ethical = box.get("ethical_pref");
    print("Ethical Pref:");
    print(ethical ?? "❌ No ethical preference saved");

    print("------------------------------------------");

    // Allergy
    final allergy = box.get("allergy_pref");
    print("Allergy Pref:");
    print(allergy ?? "❌ No allergy preference saved");

    print("------------------------------------------");

    // Medical / Conditions
    final medical = box.get("medical_pref");
    print("Medical Pref:");
    print(medical ?? "❌ No medical preference saved");

    print("------------------------------------------");

    // Lifestyle / Fitness
    final lifestyle = box.get("life_style_pref");
    print("Lifestyle Pref:");
    print(lifestyle ?? "❌ No lifestyle preference saved");

    print("------------------------------------------");

    print("========== DONE PRINTING PREFS ==========\n");
  }
